<div class="user content">
	...
	<form action="javascript:void(0);">
	  <h2>Update User</h2>
		 <div><input id="edituserID" placeholder="User ID value"></input></div><br>
		 ...
		 <div><input id="editEmail" placeholder="Email here"></input></div><br>
		 <div><input id="editCredit" placeholder="Credit here"></input></div><br>
		 <p>Edit Admin Access:</p>
		 <input type="radio" id="editRt" name="admin" value="true"> True<br>
		 <input type="radio" id="editRf" name="admin" value="false"> False<br><br>
